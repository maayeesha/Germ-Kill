...
for i in range(num_of_enemies):
    ...
    enemyY_change.append(40) #40 good too

# Injection Drop
# Enemy
dropImg = pygame.image.load("drop.png")
dropX = 0
dropY = 480  # 480 -->good too
dropX_change = 0
dropY_change = 10  # 10 # as player is also at 520
...
while running:
    ...
    if playerX <= 0:
        ...
        playerX = 736  # 736 why? Because screen width is 800 and player image is 64 pixels and hence 800 - 64 = 736
    ...
    for i in range(num_of_enemies):
        ...
        if enemyY[i] > 440:
            for j in range(num_of_enemies):
                enemyY[j] = 2000 # 2000 worked fine too
            game_over_text()
            break
